How to Submit Patches to the Budget Manager Project
===============================================================================
https://github.com/mlee2004

This document is intended to act as a guide to help you contribute to the
Budget Manager App project.  It is not perfect, and there will always be exceptions
...
The buma codea uses a fair number of unit tests to verify that
...
and potentially merged into the main budgetmanagerapp repository. The preferred
way to do this is to submit a Pull Request to the buma project.
