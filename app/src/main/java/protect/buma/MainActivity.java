...
import protect.buma.intro.IntroActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences("protect.budgetmanager", MODE_PRIVATE);
...
//        }
    ...
    private void displayAboutDialog() {
        final Map<String, String> USED_LIBRARIES = ImmutableMap.of
                (
                        "Mlee2004 on github", "https://github.com/google/mlee2004"

                );

        final Map<String, String> USED_ASSETS = ImmutableMap.of
                (
                        "Email", "mailto:mlee8015@gmail.com",
                        "Facebook", "https://www.facebook.com/mark.korir.39108",
                        "Instagram", "https://www.instagram.com/inbox/nba.lee_",
                        "Whatsapp", "https://wa.me/+97455593509"
                );
        ...
        String html =
                "<meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\" />" +
                        ...
                        appName +
                        " " +
                        String.format(getString(R.string.debug_version_fmt), "1.0") +
                        "</p><p>" +
                        ...
                        "</p><hr/><p>" +
                        String.format(getString(R.string.owner_socials), appName, resources.toString());
